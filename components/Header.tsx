    ...
    <header className="bg-white shadow-sm">
        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-primary-600 text-xl font-bold">AUGUR</span>
            </div>
            <nav className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <Link href="/distributors" className="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Distributors
              </Link>
      ...
      <div className={`${mobileMenuOpen ? 'block' : 'hidden'} sm:hidden`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link href="/distributors" className="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
            Distributors
          </Link>
        ...
        <div className="pt-4 pb-3 border-t border-gray-200">
          <div className="flex items-center px-4">
            ...
            <div className="ml-3">
              <div className="text-base font-medium text-gray-800">Admin Account</div>
              <div className="text-sm font-medium text-gray-500">admin@augur.com</div>
            </div>
          </div>
        </div>
      </div>
